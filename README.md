...
harness that reads the Agent Skills
...
| **Measured, and honest about the gaps** | `create-a-skill` was assembled by collecting every skill about authoring skills published in a repository with **5000+ stars** — twelve of them, from a vendor's own official collection (177k stars), a large community list (75k stars), `sickn33/agentic-awesome-skills` (46k) and others — reading them, and keeping what they agreed on. Where a practice was rare but right, it is kept and named. |
