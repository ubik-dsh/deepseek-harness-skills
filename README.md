...
The five fit together: `find-a-skill` finds out whether it already exists, `judge-a-skill` decides whether it is worth keeping, `create-a-skill` writes it, `learn-an-interface` is what
